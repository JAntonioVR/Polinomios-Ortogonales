...
\begin{lema}
    ...
    Sean $\rho(x)$ una función peso positiva en el intervalo $(a,b)$ con momentos finitos, $\uu$ el funcional definido como en (\ref{eq:funcional-peso}) y $\{P_n\}$ la SPO respecto a $\uu$. Si la función peso $\rho(x)$ es solución de la ecuación diferencial
    \begin{equation}
...
\begin{proof}
    ...
    \cb{REVIEW Modificada esta prueba, pero falta asegurar que el grado es exactamente $n$.}
