...
En esta sección, teniendo presente la fórmula de Rodrigues que se introdujo en la sección (\ref{subsection:Rodrigues}), presentaremos y describiremos algunas gráficas de las familias de Hermite, Laguerre y Jacobi para comprender el impacto sobre estas de la variación de los parámetros y del grado del polinomio.
