...
\begin{enumerate}
    ...
    \item Si $S$ es finito con $N+1$ elementos, $\sum_{j=0}^N P_{ij} = 1 \ \ \ \forall i\in S$ (todas las filas de $P$ suman 1).
    \item Si $S$ es infinito, $\sum_{j=0}^\infty P_{ij} = 1 \ \ \ \forall i\in S$.
\end{enumerate}
\end{proposicion}
\begin{proof}
