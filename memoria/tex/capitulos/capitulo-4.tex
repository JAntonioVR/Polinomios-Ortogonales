...
Para la redacción de este capítulo se han usado como bibliografía fundamental las referencias \cite[Ch. II, III]{Manuel}, \cite[Ch. II]{schoutens-2000}, \cite{random-walks}, \cite{Linear-Growth}, \cite{differential-equations}, entre otras.
...
\begin{figure}[ht] 
    ...
    El objetivo es aplicar el teorema espectral a un operador que, aunque no será el propio $P$, estará muy relacionado con él. Primero nos aseguraremos de que $P$ verifica las hipótesis del teorema espectral.
    ...
    \begin{proof} Sean $f,g\in\ell^2_\pi(\N_0)$.
        \begin{itemize}
            ...
            Tenemos entonces que $\|P f\|_\pi = \|\lambda f \|_\pi = |\lambda|\|f\|_\pi\leq \|f\|_\pi$ para todo valor propio $\lambda$ de $P$. Como $\|P f\|_\pi \leq \|f\|_\pi$ y $\|P\|$ es la menor constante $K\geq 0$ tal que $\|Pf\|_\pi\leq K \|f\|_\pi$, necesariamente $\|P\|\leq 1$.
